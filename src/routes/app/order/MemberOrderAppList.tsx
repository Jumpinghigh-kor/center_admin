                                      ...
                                      product.quantity == 0 && (
                                        <div key={`oos-${groupNo}-${i}`}>
                                          <div className="mt-2 bg-gray-100 px-2 py-1 flex items-center gap-2">
                                            ...
                                            <p className="text-xs font-semibold">{product.option_amount ? product.option_amount : ''} {product.option_unit !== 'NONE_UNIT' ? product.option_unit : ''} {product.option_gender == 'W' ? '여성' : product.option_gender == 'M' ? '남성' : product.option_gender == 'A' ? '공용' : '없음'} 품절</p>
                                          </div>
                                        </div>
                                      )
                                    ))}
                                          ...
                                          <div className="flex items-start justify-between mb-3 last:mb-0">
                                            <div className="flex items-start justify-between">
                                              ...
                                              <div className="ml-4">
                                                ...
                                                <p className="inline-block font-bold text-xs bg-gray-200 px-2 py-1 rounded-lg mt-2">{product.option_amount ? product.option_amount : ''} {product.option_unit !== 'NONE_UNIT' ? product.option_unit : ''} {product.option_gender == 'W' ? '여성' : product.option_gender == 'M' ? '남성' : product.option_gender == 'A' ? '공용' : '없음'}</p>
                                              </div>
                                            </div>
