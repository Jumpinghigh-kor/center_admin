...
const NoticesShoppingAppRegister: React.FC = () => {
  ...
  const handleSubmit = async () => {
    try {
      await axios.post(
        `${process.env.REACT_APP_API_URL}/app/noticesShoppingApp/insertNoticesShoppingApp`,
        {
      ...
      try {
        await axios.post(
          `${process.env.REACT_APP_API_URL}/app/postShoppingApp/insertPostShoppingApp`,
          {
            post_type: 'ALL',
...
export default NoticesShoppingAppRegister;
