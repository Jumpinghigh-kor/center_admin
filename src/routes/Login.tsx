  ...
  return (
    <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        ...
        <div className="relative px-161 bg-white shadow-lg sm:rounded-3xl sm:py-20 min-w-96 max-w-96 min-h-96 max-h-96">
                ...
                >
                  <div className="relative">
                    <input
                      ...
                      name="id"
                      type="text"
                      className="peer px-2 mt-2 placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600"
                      placeholder="아이디"
